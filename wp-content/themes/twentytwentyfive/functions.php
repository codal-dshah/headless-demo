...
function custom_register_testimonial_block() {
    // Register the block editor script (empty, since we won't use JS)
    wp_register_script(
    ...
    register_block_type('custom/testimonial', array(
        ...
        'render_callback' => 'custom_render_testimonial_block',
        'attributes'      => array(
            'quote' => array(
                'type' => 'string',
                'default' => 'This is a default testimonial quote.',
            ),
            'name' => array(
                'type' => 'string',
                'default' => 'John Doe',
...
function custom_testimonial_block_styles() {
    wp_enqueue_style(
        'custom-testimonial-block-style',
        get_template_directory_uri() . '/css/testimonial-block.css',
        array(),
        '1.0'
    );
}
add_action('enqueue_block_assets', 'custom_testimonial_block_styles');
